...
def signature_says_key_replier(body):
    ...
    sig_markers = [
        ...
        r"\n\s*Kind\s+rgds\b",
        r"\n\s*Warm\s+regards\b",
        r"\n\s*Warmest\s+regards\b",
        r"\n\s*Sincerely\b",
        r"\n\s*Yours\s+sincerely\b",
        r"\n\s*Yours\s+faithfully\b",
        r"\n\s*Yours\s+truly\b",
        r"\n\s*Regards\b",
        r"\n\s*Cheers\b",
        r"\n\s*Thanks\s*[,，]?\s*\n",
        r"\n\s*Many\s+thanks\b",
        r"\n\s*Take\s+care\b",
        r"\n\s*All\s+the\s+best\b",
        r"\n\s*Mit\s+freundlichen\s+Gr(?:üßen|üssen|uessen)\b",
        r"\n\s*Viele\s+Gr(?:üße|üsse|uesse)\b",
        r"\n\s*Beste\s+Gr(?:üße|üsse|uesse)\b",
        r"\n\s*Liebe\s+Gr(?:üße|üsse|uesse)\b",
        r"\n\s*MfG\s*[,，。:]?\s*\n",
        r"\n\s*LG\s*[,，。:]?\s*\n",
        r"\n\s*此致\s*\n",
        r"\n\s*敬上\s*\n",
...
def show_main_dashboard():
    ...
    with fc4:
        keyword = st.text_input(
            "标题 / 寄件者搜寻(选填)",
            placeholder="输入后按 Enter,清空再按 Enter 还原",
        )
